...
public class HttpProxyCacheServer {
    ...
    public void setSingleFileBandwidth(int singleFileBandwidth) {
       config.setSingleFileBandwidth(singleFileBandwidth);
    }
    /**
    ...
    public static final class Builder {
        ...
        /**单个文件下载带宽
         * @param singleFileBandwidth 单个文件下载的带宽,单位KB
         * @return a builder.
         */
        public Builder singleFileBandwidth(int singleFileBandwidth) {
        ...
        private Config buildConfig() {
            return new Config(cacheRoot, fileNameGenerator, diskUsage, sourceInfoStorage, headerInjector,singleFileBandwidth);
        }
